...
std::intptr_t dialogBox(HINSTANCE hInst,
                        StringOrId templateName,
                        HandleOr<HWND> parent,
                        DLGPROC proc);

std::intptr_t dialogBoxParam(HINSTANCE hInst,
                             StringOrId templateName,
                             HandleOr<HWND> parent,
                             DLGPROC proc,
                             std::intptr_t param);
...
int
loadString(HINSTANCE hInst, unsigned int id, wchar_t* buffer, int bufferSize);
